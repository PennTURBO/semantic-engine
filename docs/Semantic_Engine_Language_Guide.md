...
For the rest of this document, Semantic Engine Language Instances will be referred to as Instances. Actual instances of classes will be referred to as instances. The basis of the distinction is that an Instance is a component of a graph pattern implemented in SPARQL, and an instance is an actual data element that is a member of a specific class.
