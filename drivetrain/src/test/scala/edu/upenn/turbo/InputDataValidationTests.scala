...
class InputDataValidationTests extends ProjectwideGlobals with FunSuiteLike with BeforeAndAfter with Matchers
{
    ...
    test("hc encounter without ID")
    {
        ...
        {
            case e: AssertionError => assert(e.toString == "java.lang.AssertionError: assertion failed: Input data error: instance http://www.itmat.upenn.edu/biobank/hcenc1 of type http://transformunify.org/ontologies/TURBO_0010158 does not have the required connection to literal value http://transformunify.org/ontologies/healthcareEncounterSymbolLiteralValue in graph http://www.itmat.upenn.edu/biobank/Shortcuts_healthcareEncounterShortcuts")
        }
    ...
    test("hc encounter without registry")
    {
        ...
        {
            case e: AssertionError => assert(e.toString == "java.lang.AssertionError: assertion failed: Input data error: instance http://www.itmat.upenn.edu/biobank/hcenc1 of type http://transformunify.org/ontologies/TURBO_0010158 does not have the required connection to term http://transformunify.org/ontologies/HealthcareEncounterRegistryOfVariousTypes in graph http://www.itmat.upenn.edu/biobank/Shortcuts_healthcareEncounterShortcuts")
        }
    ...
    test("hc encounter without dataset")
    {
        ...
        {
            case e: AssertionError => assert(e.toString == "java.lang.AssertionError: assertion failed: Input data error: instance http://www.itmat.upenn.edu/biobank/hcenc1 of type http://transformunify.org/ontologies/TURBO_0010158 does not have the required connection to literal value http://transformunify.org/ontologies/datasetTitleStringLiteralValue in graph http://www.itmat.upenn.edu/biobank/Shortcuts_healthcareEncounterShortcuts")
        }
    ...
    test("bb encounter without registry")
    {
        ...
        {
            case e: AssertionError => assert(e.toString == "java.lang.AssertionError: assertion failed: Input data error: instance http://www.itmat.upenn.edu/biobank/bbenc1 of type http://transformunify.org/ontologies/TURBO_0010169 does not have the required connection to term http://transformunify.org/ontologies/BiobankEncounterRegistryOfVariousTypes in graph http://www.itmat.upenn.edu/biobank/Shortcuts_biobankEncounterShortcuts")
        }
    ...
    test("bb encounter without ID")
    {
        ...
        {
            case e: AssertionError => assert(e.toString == "java.lang.AssertionError: assertion failed: Input data error: instance http://www.itmat.upenn.edu/biobank/bbenc1 of type http://transformunify.org/ontologies/TURBO_0010169 does not have the required connection to literal value http://transformunify.org/ontologies/biobankEncounterSymbolStringLiteralValue in graph http://www.itmat.upenn.edu/biobank/Shortcuts_biobankEncounterShortcuts")
        }
    ...
    test("bb encounter without dataset")
    {
        ...
        {
            case e: AssertionError => assert(e.toString == "java.lang.AssertionError: assertion failed: Input data error: instance http://www.itmat.upenn.edu/biobank/bbenc1 of type http://transformunify.org/ontologies/TURBO_0010169 does not have the required connection to literal value http://transformunify.org/ontologies/datasetTitleStringLiteralValue in graph http://www.itmat.upenn.edu/biobank/Shortcuts_biobankEncounterShortcuts")
        }
