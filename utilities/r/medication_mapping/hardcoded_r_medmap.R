...
med.stand.fn <-
  "C://Users//Hayden_Freedman//PennTURBO//Drivetrain//utilities//r//medication_mapping//wes_pds__med_standard.csv"

med_map_svm_file <-
  "C://Users//Hayden_Freedman//PennTURBO//Drivetrain//utilities//r//medication_mapping//med_map_class_svm_20180503.Rdata"

endpoint <-
  "http://turbo-prd-db01.pmacs.upenn.edu:7200//repositories/dron_no_ndc"

# do you have solr running with the necessary collection ?!
# url for solr
forward.url <- "http://localhost:8983/solr/dtmeds/select"
